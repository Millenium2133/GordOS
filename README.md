...
2. [Current Shell Commands](#Current-Shell-Commands)
   2.1. [Built-In User Programs](#Built-In-User-Programs)
3. [Development Status](#Development-Status)
   3.1. [Part 1 Finishing The Kernel/Userland Split](#Part-1-Finishing-The-KernelUserland-Split)
   3.2. [Part 2 Window Manager](#Part-2-Window-Manager)
   3.3. [Suggested Order Of Operations](#Suggested-Order-Of-Operations)
4. [Technical Specifications](#Technical-Specifications)
   4.1. [Build Requirements](#Build-Requirements)
   4.2. [Hardware Requirements](#Hardware-Requirements)
   4.3. [Memory Layout](#Memory-Layout)
   4.4. [Syscall Table](#Syscall-Table)
5. [Building And Running GordOS](#Building-And-Running-GordOS)
   5.1. [Install The Dependencies](#Install-The-Dependencies)
   5.2. [Clone The Repository](#Clone-The-Repository)
   5.3. [Set Up The Cross-Compiler](#Set-Up-The-Cross-Compiler)
   5.4. [Build And Run](#Build-And-Run)
...
| dosfstools   | provides mkfs.fat, used to format disk.img as FAT32 before user programs are copied in   | apt, pacman, dnf
